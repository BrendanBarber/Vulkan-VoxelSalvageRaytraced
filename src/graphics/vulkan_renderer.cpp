...
void VulkanRenderer::initialize(GLFWwindow* window, Camera* cam) {
    this->window = window;
    this->camera = cam;

    std::cout << "=== Vulkan Initialization Starting ===\n";
...
void VulkanRenderer::createInstance() {
    std::cout << "1. Creating Vulkan Instance...\n";
    ...
    appInfo.pApplicationName = "Voxel Salvage";
    appInfo.applicationVersion = VK_MAKE_VERSION(1, 0, 0);
    appInfo.pEngineName = "No Engine"; // We're building our own!
...
void VulkanRenderer::setupDebugMessenger() {
    ...
    std::cout << "2. Setting up Debug Messenger...\n";
...
void VulkanRenderer::createSurface(GLFWwindow* window) {
    std::cout << "3. Creating Window Surface...\n";
...
void VulkanRenderer::pickPhysicalDevice() {
    std::cout << "4. Picking Physical Device (GPU)...\n";
...
void VulkanRenderer::createLogicalDevice() {
    ...
    // Device features (we don't need any special ones yet)
    ...
    // Extensions needed for swapchain
...
void VulkanRenderer::createSwapChain(GLFWwindow* window) {
    std::cout << "6. Creating Swap Chain...\n";

    VkSurfaceCapabilitiesKHR capabilities;
    vkGetPhysicalDeviceSurfaceCapabilitiesKHR(physicalDevice, surface, &capabilities);

    // Choose format (colors)
    uint32_t formatCount;
    vkGetPhysicalDeviceSurfaceFormatsKHR(physicalDevice, surface, &formatCount, nullptr);
    std::vector<VkSurfaceFormatKHR> formats(formatCount);
    vkGetPhysicalDeviceSurfaceFormatsKHR(physicalDevice, surface, &formatCount, formats.data());

    VkSurfaceFormatKHR surfaceFormat = formats[0]; // Use first available
...
void VulkanRenderer::createImageViews() {
    std::cout << "7. Creating Image Views...\n";
    ...
    std::cout << "   ✓ " << swapchainImageViews.size() << " image views created\n";
}

void VulkanRenderer::createRenderPass() {
    std::cout << "8. Creating Render Pass...\n";
...
void VulkanRenderer::createDescriptorSetLayout() {
    std::cout << "9. Creating Descriptor Set Layout...\n";
...
void VulkanRenderer::createGraphicsPipeline() {
    std::cout << "10. Creating Graphics Pipeline...\n";
    ...
    // Vertex input (none needed - we generate fullscreen quad in vertex shader)
...
void VulkanRenderer::createFramebuffers() {
    std::cout << "11. Creating Framebuffers...\n";
    ...
    std::cout << "   ✓ " << swapchainFramebuffers.size() << " framebuffers created\n";
}

void VulkanRenderer::createCommandPool() {
    std::cout << "12. Creating Command Pool...\n";
...
void VulkanRenderer::createUniformBuffer() {
    std::cout << "13. Creating Uniform Buffer...\n";
    ...
    std::cout << "   ✓ Uniform buffer created and mapped\n";
}

void VulkanRenderer::createDescriptorPool() {
    std::cout << "14. Creating Descriptor Pool...\n";
...
void VulkanRenderer::createDescriptorSets() {
    std::cout << "15. Creating Descriptor Sets...\n";
    ...
    // Configure each descriptor set to point to our uniform buffer
    for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) {
        ...
        descriptorWrite.dstBinding = 0;  // This matches "binding = 0" in the shader
    ...
    std::cout << "   ✓ Descriptor sets created and configured\n";
}

void VulkanRenderer::createCommandBuffers() {
    std::cout << "16. Creating Command Buffers...\n";
    ...
    std::cout << "   ✓ " << commandBuffers.size() << " command buffers allocated\n";
}

void VulkanRenderer::createSyncObjects() {
    std::cout << "17. Creating Synchronization Objects...\n";
    ...
    std::cout << "   ✓ Sync objects created (semaphores and fences)\n";
}
...
void VulkanRenderer::updateUniformBuffer(uint32_t currentImage) {
    ...
    ubo.cameraForward = camera->getForward();
...
void VulkanRenderer::render() {
    ...
    // Wait on the semaphore that was signaled by vkAcquireNextImageKHR
    ...
    // Signal the render finished semaphore for image
...
void VulkanRenderer::cleanup() {
    ...
    // Clean up descriptor sets (automatically freed with pool)
    ...
    std::cout << "✓ All Vulkan resources cleaned up\n";
}